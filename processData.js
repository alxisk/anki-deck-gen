const getTranscription = entries => entries[0].pronunciations[0].phoneticSpelling

const getExplanation = entries => entries.map(entry => entry.entries[0].senses[0].definitions[0])

const getExample = entries => entries.map(entry => {
